...
#include "nii_dicom.h"
    ...
    void nii_SaveBIDS(char pathoutname[], struct TDICOMdata d, struct TDCMopts opts, struct TDTI4D *dti4D, struct nifti_1_header *h, const char * filename, int nConvert, struct TDCMsort * dcmSort, struct TDICOMdata * dcmListRef);
